            ...
            <div style="width: 50%; float: right">
                ...
                <el-row>
                    <el-col :span="12">
                        ...
                        <div class="img-text">
                            <span class="textN">{{ forms.w ? forms.w :'--'}}亿m³</span>
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <span class="textL">总库容</span>
                        <div class="img-text">
                            <span class="textN">{{ forms.emptyW | numtoFixed(1) }}亿m³</span>
                        </div>
                    </el-col>
                </el-row>
                <el-row>
...
<script>
    ...
    import {realWaterLine, realWaterVol, realWaterInfo,getPointVal} from "@/http/api";
        ...
        methods: {
            ...
            async getData() {
                ...
                getPointVal(params).then(function (r) {
                    ...
                    initChartsWaterLine(that, chart, data);
